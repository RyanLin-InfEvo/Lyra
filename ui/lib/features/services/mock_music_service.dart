...
class MockMusicService implements MusicService {
  final List<Track> _tracks = [
    const Track(
      ...
      musicbrainzId: '7203e05a-8b83-4903-b09e-7bd048a1c93a',
      durationMs: 432000,
      format: 'FLAC',
      sampleRate: 96000,
      bitDepth: 24,
    ...
    const Track(
      ...
      musicbrainzId: '47023306-03f4-42b7-872f-57896fb3d45d',
      durationMs: 544000,
      format: 'FLAC',
      sampleRate: 88200,
      bitDepth: 24,
    ...
    const Track(
      ...
      musicbrainzId: '3b320ec6-9130-4eec-8c10-53bcba06a6b5',
      durationMs: 413000,
      format: 'WAV',
      sampleRate: 96000,
      bitDepth: 24,
    ...
    const Track(
      ...
      workId: 'wrk-001',
      workTitle: 'Symphony No. 9 in D minor, Op. 125 "Choral"',
      recordingYear: 1977,
      trackNumber: 4,
      discNumber: 1,
      ...
      musicbrainzId: '21f4be5c-4f76-47a3-8386-3507cf274b5c',
      durationMs: 1455000,
      format: 'FLAC',
      sampleRate: 96000,
      bitDepth: 24,
    ...
    const Track(
      ...
      musicbrainzId: '7db86df0-0b61-460d-85ad-290076cf4843',
      durationMs: 477000,
      format: 'FLAC',
      sampleRate: 96000,
      bitDepth: 24,
    ...
    const Track(
      ...
      genre: 'Roots Rock',
      isrc: 'GBF088500009',
      musicbrainzId: '86f99090-ffb8-4c12-a162-bbbe578a1a2e',
      durationMs: 418000,
      format: 'WAV',
      sampleRate: 44100,
      bitDepth: 16,
    ...
    const Track(
      ...
      albumTitle: 'Kind of Blue',
      workId: 'wrk-002',
      workTitle: 'Blue in Green',
      recordingYear: 1959,
      trackNumber: 3,
      discNumber: 1,
      genre: 'Modal Jazz',
      isrc: 'USSM15900003',
      musicbrainzId: 'bfb9b5f5-04fe-4dae-ba9b-648b260f1e82',
      durationMs: 337000,
      format: 'FLAC',
      sampleRate: 192000,
      bitDepth: 24,
  ...
  final List<Work> _works = [
    const Work(
      ...
      movement: 'IV. Presto - Allegro assai (Ode to Joy)',
    ...
    const Work(
      ...
      title: 'Giorgio by Moroder',
      composer:
          'Thomas Bangalter, Guy-Manuel de Homem-Christo, Giorgio Moroder',
    ...
    const Work(
      ...
      lyricist: 'Donald Fagen, Walter Becker',
