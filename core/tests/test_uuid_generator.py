...
class TestUuidGenerator(BaseLyraTestCase):

    def test_uuid_generator_utility(self):
        """
        Verify the C++ UuidGenerator implementation.
        """
        import subprocess
        import os
        
        executable = "./core/build/uuid_generator_test"
