...
class TestWorkController(BaseLyraTestCase):
    ...
    def test_work_create_duplicate_iswc(self):
        ...
        self.assertResponseCode(res_create1, 201)
        ...
        self.assertResponseCode(res_create2, 409)
    ...
    def test_work_update_duplicate_iswc(self):
        ...
        self.assertResponseCode(res_create2, 201)
        ...
        self.assertResponseCode(res_update, 409)
