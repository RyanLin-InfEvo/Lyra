...
class TestMakeError(BaseLyraTestCase):

    def test_make_error_utility(self):
        """
        Verify the C++ ApiResponse and ErrorType implementation.
        """
        import subprocess
        import os
        
        executable = "./core/build/make_error_test"
