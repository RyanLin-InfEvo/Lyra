...
class TestStorageHelper(BaseLyraTestCase):

    def test_storage_helper_utility(self):
        """
        Verify the C++ StorageHelper implementation.
        """
        import subprocess
        import os
        
        executable = "./core/build/storage_helper_test"
