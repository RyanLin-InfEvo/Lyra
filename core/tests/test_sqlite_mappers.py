...
class TestSqliteMappers(BaseLyraTestCase):

    def test_sqlite_mappers_utility(self):
        """
        Verify the C++ SqliteHelper query helpers and SqliteMappers implementation.
        """
        import subprocess
        import os

        executable = "./core/build/sqlite_mappers_test"
